...
var _require = __webpack_require__(87),
    RedirectMember = _require.RedirectMember;
...
var Register = function (_React$Component3) {
  ...
  _createClass(Register, [{
    key: 'render',
    value: function render() {
      return React.createElement('div', { className: 'container-single' }, React.createElement('div', { className: 'container-center' }, React.createElement('div', { className: 'single' }, React.createElement('div', { className: 'form-title' }, React.createElement('h1', null, 'Join us! ')), React.createElement(RegisterForm, null)), React.createElement(RedirectMember, null)));
    }
  }]);
...
var React = __webpack_require__(0);
var PropTypes = __webpack_require__(1);
var RegisterForm = __webpack_require__(22).RegisterForm;
...
var _require6 = __webpack_require__(89),
    WebsiteForm = _require6.WebsiteForm;
...
var RedirectMember = function (_React$Component) {
  _inherits(RedirectMember, _React$Component);

  function RedirectMember(props) {
    _classCallCheck(this, RedirectMember);

    var _this = _possibleConstructorReturn(this, (RedirectMember.__proto__ || Object.getPrototypeOf(RedirectMember)).call(this, props));

    _this.redirectMember = _this.redirectMember.bind(_this);
    return _this;
  }

  _createClass(RedirectMember, [{
    key: 'redirectMember',
    ...
    key: 'render',
    value: function render() {
      return _react2.default.createElement('div', { className: 'single' }, _react2.default.createElement('div', { className: 'form-redirect' }, _react2.default.createElement('h2', null, 'Already a Member? '), _react2.default.createElement('button', { onClick: this.redirectMember, className: 'big-button' }, 'Login')));
    }
  }]);
