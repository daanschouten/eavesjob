...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__NavLink__ = __webpack_require__(82);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Redirect__ = __webpack_require__(87);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__matchPath__ = __webpack_require__(97);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "matchPath", function() { return __WEBPACK_IMPORTED_MODULE_11__matchPath__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__withRouter__ = __webpack_require__(98);
...
var RequestWebsiteForm = function (_React$Component2) {
  ...
  _createClass(RequestWebsiteForm, [{
    ...
    value: function performRequestWebsite(e) {
      ...
      e.preventDefault();
      e.currentTarget.reset();
      _axios2.default.post('http://localhost:3000/requestWebsite', {
        name: this.state.name,
        firstLink: this.state.firstLink,
        secondLink: this.state.secondLink,
        thirdLink: this.state.thirdLink
    ...
    key: 'render',
    value: function render() {
      return React.createElement('form', { className: 'form-small', onSubmit: this.performRequestWebsite }, React.createElement('div', { className: 'form-group' }, React.createElement('input', { style: { marginBottom: "20px" }, type: 'text', placeholder: 'Website Name', className: 'big-input', name: 'name', value: this.state.name, onChange: this.handleChange })), React.createElement('div', { className: 'form-group' }, React.createElement('input', { type: 'text', placeholder: 'Career Page URL (1)', name: 'firstLink', className: 'big-input', value: this.state.firstLink, onChange: this.handleChange })), React.createElement('div', { className: 'form-group' }, React.createElement('input', { type: 'text', placeholder: 'Career Page URL (2) (optional)', name: 'secondLink', className: 'big-input', value: this.state.secondLink, onChange: this.handleChange })), React.createElement('div', { className: 'form-group' }, React.createElement('input', { type: 'text', placeholder: 'Career Page URL (3) (optional)', name: 'thirdLink', className: 'big-input', value: this.state.thirdLink, onChange: this.handleChange })), React.createElement('div', { className: 'form-group' }, React.createElement('p', null, 'Once the the request comes through, we\'ll add the company to your subscribes automatically. Keep in mind this might take up to 24 hours.')), React.createElement('div', { className: 'form-group' }, React.createElement('button', { type: 'submit', className: 'big-button' }, 'Submit Website')));
    }
  }]);
...
var KeywordForm = function (_React$Component5) {
  ...
  function KeywordForm() {
    ...
    return _possibleConstructorReturn(this, (KeywordForm.__proto__ || Object.getPrototypeOf(KeywordForm)).apply(this, arguments));
  }

  _createClass(KeywordForm, [{
    key: 'render',
    value: function render() {
      return React.createElement('form', { method: 'POST', action: '/addKeywords', className: 'form-small' }, React.createElement('div', { className: 'form-group' }, React.createElement('input', { id: 'name', type: 'text', placeholder: 'some keyword', name: 'name', className: 'big-input' })), React.createElement('div', { className: 'form-group' }, 'Category:', React.createElement('select', { 'for': 'category', name: 'category' }, React.createElement('option', { value: 'intern' }, 'intern'), React.createElement('option', { value: 'professional' }, 'professional'), React.createElement('option', { value: 'voluntary' }, 'voluntary'), React.createElement('option', { value: 'parttime' }, 'parttime'), React.createElement('option', { value: 'fulltime' }, 'fulltime '), React.createElement('option', { value: 'general' }, 'general'), React.createElement('option', { value: 'skill' }, 'skill'))), React.createElement('button', { type: 'submit', 'class': 'big-button' }, 'Add keyword'));
    }
  }]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_path_to_regexp__ = __webpack_require__(83);
...
function HandleRedirect(props) {
  return _react2.default.createElement('div', { className: 'single' }, _react2.default.createElement('div', { className: 'form-redirect' }, _react2.default.createElement('h2', null, ' ', props.title, ' '), _react2.default.createElement('button', { className: 'big-button' }, _react2.default.createElement(Link, { to: props.destination }, props.message), ' ')));
}
...
var getAuth = function getAuth(role) {
...
var PrivateRoute = function PrivateRoute(_ref) {
  ...
  return _react2.default.createElement(_reactRouterDom.Route, _extends({}, rest, { render: function render(props) {
      return getAuth("user") ? _react2.default.createElement(Component, _extends({}, rest, props)) : _react2.default.createElement(_reactRouterDom.Redirect, { to: {
          pathname: '/login',
...
var AdminRoute = function AdminRoute(_ref2) {
  ...
  return _react2.default.createElement(_reactRouterDom.Route, _extends({}, rest, { render: function render(props) {
      return getAuth("admin") ? _react2.default.createElement(Component, _extends({}, rest, props)) : _react2.default.createElement(_reactRouterDom.Redirect, { to: {
          pathname: '/',
          state: { from: props.location }
        } });
    } }));
...
var StrangerRoute = function StrangerRoute(_ref3) {
  var Component = _ref3.component,
      rest = _objectWithoutProperties(_ref3, ['component']);

  return _react2.default.createElement(_reactRouterDom.Route, _extends({}, rest, { render: function render(props) {
      return getAuth("stranger") ? _react2.default.createElement(_reactRouterDom.Redirect, { to: {
          pathname: '/profile',
          state: { from: props.location }
        } }) : _react2.default.createElement(Component, _extends({}, rest, props));
    } }));
};
...
var _require = __webpack_require__(8),
    RegisterForm = _require.RegisterForm;
...
var Home = function (_React$Component) {
  ...
  function Home(props) {
    ...
    _this.redirectSupport = _this.redirectSupport.bind(_this);
  ...
  _createClass(Home, [{
    key: 'redirectSupport',
    value: function redirectSupport() {
    ...
    key: 'render',
    value: function render() {
      return React.createElement('div', { className: 'container-single' }, React.createElement('div', { className: 'container-center' }, React.createElement('h1', { className: 'title' }, 'We monitor career pages,', React.createElement('br', null), ' so you don\'t have to.'), React.createElement('p', null, ' Checking for new vacancies can be a hassle. ', React.createElement('br', null), ' With EavesJob, you just select the career pages you\'re interested in. Whenever career opportunities appear, we\'ll send you an email.  '), React.createElement('div', { id: 'front-buttons' }, React.createElement('button', { onClick: this.redirectRegister, className: 'big-button' }, 'Sign Up Free'), React.createElement('button', { onClick: this.redirectSupport, className: 'big-button' }, 'Read More'))));
    }
  }]);
...
var _Redirect = __webpack_require__(24);
...
var Browse = function (_React$Component2) {
  ...
  function Browse(props) {
    ...
    _this2.searchFull = _this2.searchFull.bind(_this2);
    _this2.searchAvailable = _this2.searchAvailable.bind(_this2);
    return _this2;
  }
  ...
  _createClass(Browse, [{
    ...
    key: 'searchAvailable',
    value: function searchAvailable() {
      var _this4 = this;

      // refresh only available
      _axios2.default.post('http://localhost:3000/search/' + this.state.user._id, {
    ...
    key: 'render',
    value: function render() {
      return React.createElement('div', { id: 'two-thirds-page' }, React.createElement('div', { id: 'two-thirds-left' }, React.createElement(Search, { onQueryChange: this.onQueryChange }), React.createElement(Available, {
...
function Contact(props) {
  return React.createElement('div', { id: 'two-thirds-page' }, React.createElement('div', { id: 'two-thirds-left' }), React.createElement('div', { className: 'right-sidebar' }));
}
...
var AddKeyword = function (_React$Component) {
  ...
  function AddKeyword() {
    _classCallCheck(this, AddKeyword);

    return _possibleConstructorReturn(this, (AddKeyword.__proto__ || Object.getPrototypeOf(AddKeyword)).apply(this, arguments));
  }

  _createClass(AddKeyword, [{
    key: 'render',
    value: function render() {
      return React.createElement('div', { className: 'container-single' }, React.createElement('div', { className: 'container-center' }, React.createElement('div', { className: 'single' }, React.createElement('div', { className: 'form-title' }, React.createElement('h1', null, 'Add Keywords')), React.createElement(KeywordForm, null))));
    }
  }]);
...
var AddWebsite = function (_React$Component2) {
  _inherits(AddWebsite, _React$Component2);

  function AddWebsite() {
    _classCallCheck(this, AddWebsite);

    return _possibleConstructorReturn(this, (AddWebsite.__proto__ || Object.getPrototypeOf(AddWebsite)).apply(this, arguments));
  }
...
// module
exports.push([module.i, "body,\ndiv,\nh1,\nh2,\nh3,\np,\nheader {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\ndiv,\nheader,\nform,\nbutton,\ninput,\nfooter {\n  display: flex;\n  box-sizing: border-box;\n}\nbody {\n  background-color: #f5f5f5;\n}\n@font-face {\n  font-family: RobotoCondensed;\n  src: url(" + escape(__webpack_require__(57)) + ");\n}\n@font-face {\n  font-family: RobotoLight;\n  src: url(" + escape(__webpack_require__(58)) + ");\n}\n@font-face {\n  font-family: RobotoRegular;\n  src: url(" + escape(__webpack_require__(59)) + ");\n}\n@font-face {\n  font-family: RobotoCondensedRegular;\n  src: url(" + escape(__webpack_require__(60)) + ");\n}\nh1,\nh2,\nh3,\nh4,\nh5 {\n  font-family: RobotoCondensed;\n}\np,\ninput {\n  font-family: RobotoRegular;\n}\n#main {\n  width: 100%;\n  flex-flow: column;\n}\nheader {\n  width: 100%;\n  justify-content: space-between;\n  align-content: center;\n  padding: 0 40px;\n  height: 55px;\n  background: #619B8A;\n  color: white;\n}\nheader a {\n  font-family: RobotoRegular;\n  margin: 0 15px;\n  font-size: 1.1em;\n  text-decoration: none;\n  color: white;\n}\nheader a#header-sign-up {\n  padding: 5px 20px;\n  margin: 0 20px;\n  border: 2px solid #619B8A;\n}\nheader #logo {\n  align-items: center;\n}\nheader #menu {\n  align-items: center;\n}\n.container-single {\n  width: 100%;\n  min-height: 100vh;\n  margin-top: 15vh;\n  justify-content: center;\n}\n.container-single .container-center {\n  width: 100%;\n  align-items: center;\n  flex-flow: column;\n}\n.container-single .container-center h1.title {\n  font-size: 55px;\n  margin: 0;\n  font-family: RobotoCondensed;\n  text-align: center;\n}\n.container-single .container-center p {\n  font-family: RobotoRegular;\n  font-size: 1.4em;\n  line-height: 1.4em;\n  max-width: 450px;\n  margin-bottom: 20px;\n  text-align: justify;\n}\n.container-single .container-center p:first-of-type {\n  margin: 50px 0 20px 0;\n}\n.container-single .container-center #front-buttons {\n  justify-content: space-between;\n  margin: 10px 0;\n}\n.container-single .container-center #front-buttons button {\n  font-family: RobotoCondensedRegular;\n  font-size: 1.1em;\n  padding: 10px 20px;\n  border: 0px;\n  background: #619B8A;\n  color: white;\n  margin: 0 20px;\n  border-radius: 5px;\n  outline: none;\n}\n.container-single .container-center #front-buttons button:hover {\n  color: black;\n  cursor: pointer;\n}\n.container-double {\n  width: 100%;\n  min-height: 100vh;\n  margin-top: 15vh;\n  justify-content: space-around;\n}\n.container-double .container-left {\n  align-items: center;\n  flex-flow: column;\n  width: 50%;\n  margin-top: 10px;\n}\n.container-double .container-left h2.title {\n  font-size: 50px;\n  margin: 0;\n  font-family: RobotoCondensed;\n  text-align: center;\n}\n.container-double .container-left p {\n  font-family: RobotoCondensedRegular;\n  font-size: 1.4em;\n  text-align: justify;\n  max-width: 450px;\n  margin-bottom: 20px;\n}\n.container-double .container-left p:first-of-type {\n  margin: 50px 0 20px 0;\n}\n#two-thirds-page {\n  width: 100%;\n  min-height: 100vh;\n  padding: 40px 50px;\n  justify-content: space-between;\n}\n#two-thirds-page #two-thirds-left {\n  width: 70%;\n  flex-flow: column;\n}\n#two-thirds-page #two-thirds-left #search-website {\n  padding: 30px 5%;\n  background: #FFFFFF;\n  border: 1px solid #EAEAEA;\n  border-radius: 5px;\n  margin-bottom: 30px;\n  justify-content: space-between;\n  align-items: center;\n  font-family: RobotoLight;\n}\n#two-thirds-page #two-thirds-left #search-website .search-div {\n  height: 40px;\n  width: 50%;\n}\n#two-thirds-page #two-thirds-left #search-website .search-div .search-form {\n  width: 100%;\n}\n#two-thirds-page #two-thirds-left #search-website .search-div .search-form .search-bar {\n  width: 100%;\n  justify-content: space-between;\n  background: #e6e6e6;\n}\n#two-thirds-page #two-thirds-left #search-website .search-div .search-form .search-bar input {\n  flex: 10 1 50%;\n  border: none;\n  padding: 0 10px;\n  background: none;\n  outline: none;\n  font-size: 1.1em;\n  font-family: RobotoLight;\n}\n#two-thirds-page #two-thirds-left #search-website .search-div .search-form .search-bar button {\n  border: none;\n  width: 60px;\n  justify-content: center;\n  padding: 0;\n  background: none;\n}\n#two-thirds-page #two-thirds-left #search-website .search-div .search-form .search-bar button :hover {\n  cursor: pointer;\n}\n#two-thirds-page #two-thirds-left #search-website .search-div .search-form .search-bar button img {\n  width: 35%;\n  height: auto;\n}\n#two-thirds-page #two-thirds-left #website-list {\n  padding: 30px 0;\n  flex-flow: column;\n  background: #FFFFFF;\n  align-items: center;\n  border: 1px solid #EAEAEA;\n  border-radius: 5px;\n}\n#two-thirds-page #two-thirds-left #website-list .single-website {\n  width: 100%;\n  border-bottom: 0.5px solid #EAEAEA;\n  justify-content: space-between;\n  align-items: center;\n  padding: 12px 5%;\n  font-size: 1.1em;\n}\n#two-thirds-page #two-thirds-left #website-list .single-website .single-logo {\n  width: 10%;\n  justify-content: flex-start;\n}\n#two-thirds-page #two-thirds-left #website-list .single-website .single-monitor {\n  width: 10%;\n  justify-content: center;\n}\n#two-thirds-page #two-thirds-left #website-list .single-website .single-monitor img {\n  height: 20px;\n  width: auto;\n}\n#two-thirds-page #two-thirds-left #website-list .single-website .single-monitor img:hover {\n  cursor: pointer;\n}\n#two-thirds-page #two-thirds-left #website-list .single-website .single-date {\n  width: 25%;\n  justify-content: flex-end;\n}\n#two-thirds-page #two-thirds-left #website-list .single-website .single-name {\n  width: 55%;\n}\n#two-thirds-page #two-thirds-left #website-list .single-website:nth-child(even) {\n  background: linear-gradient(to right, #e6e6e6, #FFFFFF);\n}\n#two-thirds-page #two-thirds-left #website-list .single-website:hover {\n  background: #619B8A;\n}\n#two-thirds-page #two-thirds-left #website-list .single-website:first-of-type:hover {\n  background: #FFFFFF;\n}\n#two-thirds-page #two-thirds-left #profile-premium {\n  padding: 30px 5%;\n  background: #FFFFFF;\n  border: 1px solid #EAEAEA;\n  border-radius: 5px;\n  margin: 30px 0;\n  justify-content: space-between;\n  align-items: center;\n  font-family: RobotoLight;\n}\n#two-thirds-page #two-thirds-left #no-results {\n  display: none;\n  padding: 30px 5%;\n  background: #FFFFFF;\n  border: 1px solid #EAEAEA;\n  border-radius: 5px;\n  flex-flow: column;\n  align-items: center;\n  font-family: RobotoLight;\n}\n#two-thirds-page #two-thirds-left #no-results #results-text {\n  width: 100%;\n  justify-content: space-between;\n  align-items: center;\n  margin: 30px 0;\n}\n#two-thirds-page #two-thirds-left #no-results #results-text h2 {\n  min-width: 100px;\n  margin-right: 30px;\n}\n#two-thirds-page #two-thirds-left #no-results #results-text p {\n  font-size: 1.1em;\n}\n#two-thirds-page #two-thirds-left #no-results #results-text i {\n  color: #619B8A;\n}\n#two-thirds-page #two-thirds-left #no-results #request-website form {\n  flex-flow: column;\n}\n#two-thirds-page .right-sidebar {\n  width: 25%;\n  flex-flow: column;\n}\n#two-thirds-page .right-sidebar #monitored-websites,\n#two-thirds-page .right-sidebar .request-website,\n#two-thirds-page .right-sidebar #welcome-user {\n  background: #FFFFFF;\n  border: 1px solid #EAEAEA;\n  border-radius: 5px;\n  margin-bottom: 30px;\n  flex-flow: column;\n}\n#two-thirds-page .right-sidebar #monitored-websites .right-sidebar-title,\n#two-thirds-page .right-sidebar .request-website .right-sidebar-title,\n#two-thirds-page .right-sidebar #welcome-user .right-sidebar-title {\n  width: 100%;\n  padding: 30px 5%;\n  height: 100px;\n  align-items: center;\n  justify-content: space-between;\n}\n#two-thirds-page .right-sidebar #monitored-websites .right-sidebar-title p,\n#two-thirds-page .right-sidebar .request-website .right-sidebar-title p,\n#two-thirds-page .right-sidebar #welcome-user .right-sidebar-title p {\n  font-size: 1.1em;\n}\n#two-thirds-page .right-sidebar #monitored-websites .right-sidebar-title button,\n#two-thirds-page .right-sidebar .request-website .right-sidebar-title button,\n#two-thirds-page .right-sidebar #welcome-user .right-sidebar-title button {\n  font-family: RobotoRegular;\n  font-size: 1.1em;\n  padding: 10px 20px;\n  border: 0px;\n  background: #619B8A;\n  border-radius: 5px;\n  margin: 10px 0;\n  outline: none;\n}\n#two-thirds-page .right-sidebar #monitored-websites .right-sidebar-title button:hover,\n#two-thirds-page .right-sidebar .request-website .right-sidebar-title button:hover,\n#two-thirds-page .right-sidebar #welcome-user .right-sidebar-title button:hover {\n  cursor: pointer;\n}\n#two-thirds-page .right-sidebar #monitored-websites .single-website,\n#two-thirds-page .right-sidebar .request-website .single-website,\n#two-thirds-page .right-sidebar #welcome-user .single-website {\n  width: 100%;\n  border-bottom: 0.5px solid #EAEAEA;\n  justify-content: space-between;\n  align-items: center;\n  padding: 12px 5%;\n  font-size: 1.1em;\n}\n#two-thirds-page .right-sidebar #monitored-websites .single-website .single-logo,\n#two-thirds-page .right-sidebar .request-website .single-website .single-logo,\n#two-thirds-page .right-sidebar #welcome-user .single-website .single-logo {\n  display: none;\n}\n#two-thirds-page .right-sidebar #monitored-websites .single-website .single-monitor,\n#two-thirds-page .right-sidebar .request-website .single-website .single-monitor,\n#two-thirds-page .right-sidebar #welcome-user .single-website .single-monitor {\n  width: 30%;\n  justify-content: flex-end;\n}\n#two-thirds-page .right-sidebar #monitored-websites .single-website .single-monitor img,\n#two-thirds-page .right-sidebar .request-website .single-website .single-monitor img,\n#two-thirds-page .right-sidebar #welcome-user .single-website .single-monitor img {\n  height: 20px;\n  width: auto;\n}\n#two-thirds-page .right-sidebar #monitored-websites .single-website .single-monitor img:hover,\n#two-thirds-page .right-sidebar .request-website .single-website .single-monitor img:hover,\n#two-thirds-page .right-sidebar #welcome-user .single-website .single-monitor img:hover {\n  cursor: pointer;\n}\n#two-thirds-page .right-sidebar #monitored-websites .single-website .single-date,\n#two-thirds-page .right-sidebar .request-website .single-website .single-date,\n#two-thirds-page .right-sidebar #welcome-user .single-website .single-date {\n  display: none;\n}\n#two-thirds-page .right-sidebar #monitored-websites .single-text,\n#two-thirds-page .right-sidebar .request-website .single-text,\n#two-thirds-page .right-sidebar #welcome-user .single-text {\n  width: 100%;\n  border-bottom: 0.5px solid #EAEAEA;\n  justify-content: space-between;\n  padding: 0 5% 12px 5%;\n  font-size: 1.1em;\n  justify-content: center;\n}\n#two-thirds-page .right-sidebar #monitored-websites .single-text button,\n#two-thirds-page .right-sidebar .request-website .single-text button,\n#two-thirds-page .right-sidebar #welcome-user .single-text button {\n  font-family: RobotoRegular;\n  font-size: 1.1em;\n  padding: 10px 20px;\n  border: 0px;\n  background: #619B8A;\n  border-radius: 5px;\n  margin: 10px 0;\n  outline: none;\n}\n#two-thirds-page .right-sidebar #monitored-websites .single-text button:hover,\n#two-thirds-page .right-sidebar .request-website .single-text button:hover,\n#two-thirds-page .right-sidebar #welcome-user .single-text button:hover {\n  cursor: pointer;\n}\n#two-thirds-page .right-sidebar #monitored-websites .single-website:nth-child(even),\n#two-thirds-page .right-sidebar .request-website .single-website:nth-child(even),\n#two-thirds-page .right-sidebar #welcome-user .single-website:nth-child(even) {\n  background: linear-gradient(to right, #e6e6e6, #FFFFFF 90%);\n}\n#two-thirds-page .right-sidebar #monitored-websites .single-website:hover,\n#two-thirds-page .right-sidebar .request-website .single-website:hover,\n#two-thirds-page .right-sidebar #welcome-user .single-website:hover {\n  background: #619B8A;\n}\n#two-thirds-page .right-sidebar #monitored-websites .single-website:first-of-type:hover,\n#two-thirds-page .right-sidebar .request-website .single-website:first-of-type:hover,\n#two-thirds-page .right-sidebar #welcome-user .single-website:first-of-type:hover {\n  background: #FFFFFF;\n}\n.container-right {\n  width: 50%;\n}\n.container-center,\n.container-right {\n  flex-flow: column;\n  align-items: center;\n}\n.container-center .single,\n.container-right .single {\n  width: 500px;\n  flex-flow: column;\n  background: #FFFFFF;\n  align-items: center;\n  border: 1px solid #EAEAEA;\n  border-radius: 5px;\n  margin-bottom: 20px;\n}\n.container-center .single .form-redirect,\n.container-right .single .form-redirect {\n  width: 80%;\n  justify-content: space-between;\n  align-items: center;\n  padding: 20px 0;\n}\n.container-center .single .form-redirect button,\n.container-right .single .form-redirect button {\n  width: 48%;\n}\n.container-center .single .form-title,\n.container-right .single .form-title {\n  width: 80%;\n  margin-top: 20px;\n  justify-content: flex-start;\n}\n.container-center .single .form-title p,\n.container-right .single .form-title p {\n  font-size: 1.1em;\n}\n.container-center .single .form-title-vertical,\n.container-right .single .form-title-vertical {\n  width: 80%;\n  margin: 20px 0;\n  justify-content: flex-start;\n  flex-flow: column;\n}\n.container-center .single .form-title-vertical p,\n.container-right .single .form-title-vertical p {\n  margin-top: 10px;\n  font-size: 1.1em;\n}\n.container-center .single .form-title-vertical a,\n.container-right .single .form-title-vertical a {\n  color: #619B8A;\n}\n.container-center .single .form-small,\n.container-right .single .form-small {\n  flex-flow: column;\n  width: 80%;\n  padding: 10px 0;\n}\n.container-center .single .form-small .form-group,\n.container-right .single .form-small .form-group {\n  justify-content: space-between;\n}\n.container-center .single .form-small .form-group input,\n.container-right .single .form-small .form-group input {\n  width: 100%;\n}\n.container-center .single .form-small .form-group input.half,\n.container-right .single .form-small .form-group input.half {\n  width: 48%;\n}\n.container-center .single .form-small .form-group button,\n.container-right .single .form-small .form-group button,\n.container-center .single .form-small .form-group p,\n.container-right .single .form-small .form-group p {\n  width: 100%;\n  margin: 15px 0;\n  font-size: 1.1em;\n}\n.big-input {\n  height: 45px;\n  padding: 10px;\n  margin-top: 15px;\n  font-size: 1em;\n  background: #e6e6e6;\n  border: 1px solid #e6e6e6;\n  outline: none;\n  border-radius: 5px;\n}\n.big-button {\n  height: 45px;\n  padding: 10px;\n  background: #e6e6e6;\n  outline: none;\n  border-radius: 5px;\n  background: #619B8A;\n  font-size: 1.1em;\n  justify-content: center;\n}\n.big-button a {\n  text-decoration: none;\n  color: black;\n}\nbutton:hover,\nbutton:focus {\n  cursor: pointer;\n  color: white;\n}\nbutton:hover a,\nbutton:focus a {\n  cursor: pointer;\n  color: white;\n}\ninput:focus,\ninput:hover {\n  border: 1px solid #619B8A;\n}\n.switch {\n  display: inline-block;\n  position: relative;\n  cursor: pointer;\n  width: 40px;\n  height: calc(20px);\n  border-radius: 60px;\n  background-color: #619B8A;\n}\n.switch .switch__toggle {\n  width: 0;\n  height: 0;\n  opacity: 0;\n  position: absolute;\n  top: 0;\n  left: 0;\n}\n.switch .switch__toggle:checked ~ .switch__label:before {\n  transform: scale(0);\n  opacity: .7;\n}\n.switch .switch__toggle:checked ~ .switch__label:after {\n  transform: translate3d(100%, -50%, 0);\n}\n.switch .switch__toggle:checked ~ .switch__label {\n  box-shadow: 0 0 0 1px white;\n}\n.switch .switch__label {\n  display: block;\n  width: 100%;\n  height: 100%;\n  border-radius: 60px;\n  box-shadow: 0 0 0 1px #619B8A;\n}\n.switch .switch__label:before,\n.switch .switch__label:after {\n  content: \"\";\n  cursor: pointer;\n  position: absolute;\n  top: 0;\n  left: 0;\n  background: #f5f5f5;\n}\n.switch .switch__label:before {\n  width: 100%;\n  height: 100%;\n  box-sizing: border-box;\n  border-radius: 60px;\n  transition: opacity 0.2s ease-out 0.1s, transform 0.2s ease-out 0.1s;\n  transform: scale(1);\n  opacity: 1;\n}\n.switch .switch__label:after {\n  top: 50%;\n  z-index: 3;\n  transition: transform 0.4s cubic-bezier(0.44, -0.12, 0.07, 1.15);\n  width: calc(20px);\n  height: calc(20px);\n  transform: translate3d(0, -50%, 0);\n  border-radius: 100%;\n  box-shadow: 0 2px 5px rgba(0, 0, 0, 0.3);\n}\nfooter {\n  width: 100%;\n  padding: 30px 10%;\n  height: 300px;\n  background: #619B8A;\n  justify-content: space-between;\n}\nfooter #footer-left {\n  width: 40%;\n}\nfooter #footer-left .footer-column {\n  width: 80%;\n  height: 100%;\n}\nfooter #footer-right {\n  width: 60%;\n  justify-content: space-between;\n  padding-left: 10%;\n}\nfooter #footer-right .footer-column {\n  width: 40%;\n  height: 100%;\n}\nfooter #footer-right,\nfooter #footer-left {\n  height: 100%;\n}\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_history_createBrowserHistory__ = __webpack_require__(76);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_MemoryRouter__ = __webpack_require__(80);
// Written in this round about way for babel-transform-imports
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_prop_types__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_history_createMemoryHistory__ = __webpack_require__(81);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_Prompt__ = __webpack_require__(86);
// Written in this round about way for babel-transform-imports
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_Redirect__ = __webpack_require__(88);
// Written in this round about way for babel-transform-imports
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createBrowserHistory__ = __webpack_require__(90);
/* unused harmony reexport createBrowserHistory */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__createHashHistory__ = __webpack_require__(91);
/* unused harmony reexport createHashHistory */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__createMemoryHistory__ = __webpack_require__(92);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_Switch__ = __webpack_require__(96);
// Written in this round about way for babel-transform-imports
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_withRouter__ = __webpack_require__(99);
// Written in this round about way for babel-transform-imports
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_hoist_non_react_statics__ = __webpack_require__(100);
...
var _require7 = __webpack_require__(50),
    RequestWebsite = _require7.RequestWebsite;

var _require8 = __webpack_require__(50),
    Contact = _require8.Contact;

var _require9 = __webpack_require__(51),
    AddWebsite = _require9.AddWebsite;

var _require10 = __webpack_require__(51),
    AddKeyword = _require10.AddKeyword;

var _require11 = __webpack_require__(27),
    PrivateRoute = _require11.PrivateRoute;

var _require12 = __webpack_require__(27),
    StrangerRoute = _require12.StrangerRoute;

var _require13 = __webpack_require__(27),
    AdminRoute = _require13.AdminRoute;
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { id: 'main' }, _react2.default.createElement(_Header2.default, { user: this.state.user }), _react2.default.createElement(_reactRouterDom.Switch, null, _react2.default.createElement(_reactRouterDom.Route, { path: '/', exact: true, render: function render(props) {
        ...
        } }), _react2.default.createElement(_reactRouterDom.Route, { path: '/contact', component: Contact }), _react2.default.createElement(StrangerRoute, { path: '/login', component: Login, onLogin: this.onLogin }), _react2.default.createElement(StrangerRoute, { path: '/register', component: Register, onRegister: this.onRegister }), _react2.default.createElement(PrivateRoute, { path: '/browse', component: Browse, user: this.state.user }), _react2.default.createElement(PrivateRoute, { path: '/profile', component: Profile, user: this.state.user, handleLogout: this.onLogout }), _react2.default.createElement(PrivateRoute, { path: '/requestWebsite', component: RequestWebsite, user: this.state.user }), _react2.default.createElement(AdminRoute, { path: '/addWebsite', component: AddWebsite }), _react2.default.createElement(AdminRoute, { path: '/addKeyword', component: AddKeyword }), _react2.default.createElement(_reactRouterDom.Route, { component: _2.default })), _react2.default.createElement(_Footer2.default, null));
    }
  }, {
    key: 'redirectUser',
...
var MenuLoggedIn = function (_React$Component) {
  ...
  _createClass(MenuLoggedIn, [{
    key: 'render',
    value: function render() {
      return React.createElement('div', { id: 'menu' }, React.createElement(NavLink, { to: '/contact' }, 'Contact'), React.createElement(NavLink, { to: '/profile' }, 'My Profile'));
    }
  }]);
...
var MenuNotLoggedIn = function (_React$Component2) {
  ...
  _createClass(MenuNotLoggedIn, [{
    key: 'render',
    value: function render() {
      return React.createElement('div', { id: 'menu' }, React.createElement(NavLink, { to: '/contact' }, 'Contact'), React.createElement(NavLink, { id: 'header-sign-up', to: '/register' }, 'Sign Up'), React.createElement(NavLink, { to: '/login' }, 'Login'));
    }
  }]);
...
var NotFound = function (_React$Component) {
  ...
  _createClass(NotFound, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement('div', { className: 'container-single' }, _react2.default.createElement('div', { className: 'container-center' }, _react2.default.createElement('div', { className: 'single' }, _react2.default.createElement('div', { className: 'form-title' }, _react2.default.createElement('h1', null, '404: Page not Found')), _react2.default.createElement('p', null, ' The page you\'re attempting to visit doesn\'t exist. Are you sure you should be here? ')), _react2.default.createElement(_Redirect2.default, { destination: '/', title: 'Back to Safety', message: 'Visit Homepage' })));
    }
  }]);
...
var Profile = function (_React$Component) {
  ...
  _createClass(Profile, [{
    ...
    key: 'render',
    value: function render() {
      return React.createElement('div', { id: 'two-thirds-page' }, React.createElement('div', { id: 'two-thirds-left' }, React.createElement('div', { id: 'search-website' }, React.createElement('h2', null, 'selected career pages')), React.createElement(Available, {
        onChangeSubscribe: this.onChangeSubscribe,
        available: this.state.monitored }), React.createElement('div', { id: 'profile-premium' }, React.createElement('h2', null, 'go premium'))), React.createElement('div', { className: 'right-sidebar' }, React.createElement('div', { id: 'welcome-user' }, React.createElement('div', { className: 'right-sidebar-title' }, React.createElement('p', null, 'Hi ', this.props.user.firstName, '!'), React.createElement('button', { className: 'big-button', onClick: this.props.handleLogout }, ' Log out '))), React.createElement('div', { className: 'request-website' }, React.createElement('div', { className: 'right-sidebar-title' }, React.createElement('h2', null, 'find more career pages ')), React.createElement('div', { className: 'single-text' }, React.createElement('p', null, ' ')), React.createElement('div', { className: 'single-text' }, React.createElement('button', { className: 'big-button' }, React.createElement(Link, { to: '/browse' }, 'browse career pages'))))));
    }
  }]);
